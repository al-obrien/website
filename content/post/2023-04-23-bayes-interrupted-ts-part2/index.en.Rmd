...
The results of the comparison are in reference to the model with the highest **ELPD**. After seeing the earlier plots and excluding the AR model, it is probably unsurprising that the best fit is `model_level_slope_season_s`, which has the spline term for seasonal effects. 
